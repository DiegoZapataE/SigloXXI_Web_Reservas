 ...
 */
@WebServlet(name = "Totem", urlPatterns = {"/conoce-tu-mesa"})
public class Totem extends HttpServlet {
...
//Inicializamos y definimos las variables a utilizar
        ...
        rutCompletoCliente = rutCompletoCliente.replace("-", "");
        int rut = Integer.parseInt(rutCompletoCliente.substring(0, rutCompletoCliente.length() - 1));
